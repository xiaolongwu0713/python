...
PD_train_y=[1]*len(PD_train)
PD_val_y=[1]*len(PD_val)
PD_test_y=[1]*len(PD_test)

others_train_y=[2]*len(others_train)
others_val_y=[2]*len(others_val)
others_test_y=[2]*len(others_test)


NC_train_y=[3]*len(NC_train)
NC_val_y=[3]*len(NC_val)
