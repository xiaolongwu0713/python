'''
test on another particular subject;
train and validate on the rest subjects;
'''
...
from sEMG_Zhangbin.dataset_LOO import sub_split,split_data,windowing
...
ET_data_tmp,PD_data_tmp,others_data_tmp,NC_data_tmp,test_data_tmp=sub_split()
ET_train_tmp, ET_val_tmp,PD_train_tmp,PD_val_tmp,others_train_tmp, others_val_tmp,NC_train_tmp, NC_val_tmp=\
    split_data(ET_data_tmp, PD_data_tmp,others_data_tmp,NC_data_tmp)
...
filename=result_path + 'train_result_LOO.npy'
