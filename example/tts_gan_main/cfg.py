...
def parse_args():
    ...
    parser.add_argument('--gpu', default=None, type=int,
                        help='GPU id to use.')
    parser.add_argument('--multiprocessing-distributed', action='store_true', # false
    ...
    parser.add_argument(
        '--max_iter', # this will over-write the max_epoch parameter
        type=int,
        default=5000, # 500000
    ...
    parser.add_argument(
        ...
        help='adam: decay of first order momentum of gradient')
    parser.add_argument(
        '--num_workers', # > 1 will dramatically slow down the training
        type=int,
        default=1,
    ...
    parser.add_argument('--optimizer', type=str, default="adam",
                        help='optimizer')
    parser.add_argument('--loss', type=str, default="lsgan", # lsgan/wgangp
                        help='loss function')
    ...
    parser.add_argument('--fade_in', type=float, default=0.0,
                        help='fade in step')
    ...
    parser.add_argument('--d_heads', type=int, default=4, # o:4
