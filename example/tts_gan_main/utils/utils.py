...
def set_log_dir(log_dir): # set root_dir to H: driver, and set exp_name to sid
    path_dict = {}
    ...
    ## save it for every epoch
    #aa = "H:/Long/data/gesture/DA/TTS-GAN/checkpoints/" + timestamp + '/'
    #os.makedirs(aa)
    #path_dict['ckpt_path'] = aa
...
def save_checkpoint(epoch,states, is_best, output_dir,
                    filename='checkpoint.pth'):
    filename=output_dir+'checkpoint_'+str(epoch)+'.pth'
