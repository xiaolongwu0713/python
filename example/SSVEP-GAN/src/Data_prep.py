...
# class0
data_class0 = [np.load('../Sampledata/SampleData_class0.npy')]
data_class0 = np.concatenate(data_class0) 
label_class0 = [np.load('../Sampledata/SampleData_class0_labels.npy')]
label_class0 = np.concatenate(label_class0)
# pre-processing
data_class0 = data_process(data_class0.transpose(0,2,1))

# class1
data_class1 = [np.load('../Sampledata/SampleData_class1.npy')]
data_class1 = np.concatenate(data_class1) 
label_class1 = [np.load('../Sampledata/SampleData_class1_labels.npy')]
label_class1 = np.concatenate(label_class1)
# pre-processing
data_class1 = data_process(data_class1.transpose(0,2,1))

# class2
data_class2 = [np.load('../Sampledata/SampleData_class2.npy')]
data_class2 = np.concatenate(data_class2) 
label_class2 = [np.load('../Sampledata/SampleData_class2_labels.npy')]
label_class2 = np.concatenate(label_class2)
# pre-processing
data_class2 = data_process(data_class2.transpose(0,2,1))
