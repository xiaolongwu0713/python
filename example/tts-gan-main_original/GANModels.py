...
class Generator(nn.Module):
    def __init__(self, seq_len=150, patch_size=15, channels=3, num_classes=9, latent_dim=100, embed_dim=10, depth=3,
        ...
        self.asFilter=nn.Conv1d(in_channels=3,out_channels=3,kernel_size=11,padding=5)
    ...
    def forward(self, z):
        ...
        output = self.deconv(x.permute(0, 3, 1, 2)) # torch.Size([16, 3, 1, 150])
        output=torch.squeeze(output,2)# torch.Size([16, 3, 150])
