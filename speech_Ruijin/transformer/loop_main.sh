...
then
  ...
  do
    ...
    /cygdrive/c/Users/xiaowu/anaconda3/envs/bci/python.exe main.py $sid $dataname $time_stamp $mel_bins
    ...
    /cygdrive/c/Users/xiaowu/anaconda3/envs/bci/python.exe synthesize_waveglow.py $sid $dataname $time_stamp $mel_bins
  done
