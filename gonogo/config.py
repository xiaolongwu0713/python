...
if socket.gethostname() == 'LongsMac':
    ...
    data_dir = 'H:/Long/data/ruijin/gonogo/'  # temp data dir
    result_dir='H:/Long/BaiduNetdiskWorkspace/BCI/result/python/ruijin/gonogo/'
    matlab_result_dir='H:/Long/BaiduNetdiskWorkspace/BCI/result/matlab/ruijin/gonogo/'
