'''
Using script in MCD_issues.ipynb, the MCD of dataset 10 is unexpected larger than dataset 1, therefore this script tries a different github repo.

However, script exits with error when calculate dataset 22.
Processing -----------22.wav
...
natural_folder = 'D:/tmp/mcd/target/'
synth_folder = 'D:/tmp/mcd/pred/'
