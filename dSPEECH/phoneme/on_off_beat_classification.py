'''
This script is to discriminate between onbeat and offbeat;
'''
...
sid=2 # 1/2
sf=1024
result_dir = data_dir + 'processed/'+modality+str(sid)+'/on_off_beat/'
filename=result_dir+'on_off_epochs.npy'
