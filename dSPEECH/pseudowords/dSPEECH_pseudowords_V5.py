...
counts={i:0 for i in [' ', 'm', 'n', 'ng', 'p', 't', 'k', 'ee', 'oo', 'a']}
IMF =  { 'm' : {'initial':0, 'medial':0, 'final':0},
		 'n' : {'initial':0, 'medial':0, 'final':0},
		'ng' : {'initial':0, 'medial':0, 'final':0},
		 'p' : {'initial':0, 'medial':0, 'final':0},
		 't' : {'initial':0, 'medial':0, 'final':0},
		 'k' : {'initial':0, 'medial':0, 'final':0},
		 'ee' : {'initial':0, 'medial':0, 'final':0},
		 'oo' : {'initial':0, 'medial':0, 'final':0},
		 'a' : {'initial':0, 'medial':0, 'final':0},
		}
