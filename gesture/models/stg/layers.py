...
import torch
import math
from gesture.models.stg.utils import get_batcnnorm, get_dropout, get_activation
...
class FeatureSelector(nn.Module):
    ...
    def forward(self, prev_x):
        ...
        stochastic_gate = self.hard_sigmoid(z) # torch.Size([208])
        prev_x = prev_x.permute(0, 2, 1) #([32, 208, 500]) --->torch.Size([32, 500, 208])
